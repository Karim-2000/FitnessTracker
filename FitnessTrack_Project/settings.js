document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('nutritionalGoalsForm').addEventListener('submit', function(e) {
        ...
        const nutritionalGoals = {
            calories: document.getElementById('calorieGoal').value,
            protein: document.getElementById('proteinGoal').value,
            carbs: document.getElementById('carbsGoal').value,
            fat: document.getElementById('fatGoal').value
        };
        updateNutritionalGoals(nutritionalGoals);
    });
